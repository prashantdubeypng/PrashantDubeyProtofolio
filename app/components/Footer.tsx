...
export default function Footer() {
  ...
  return (
    <footer className="relative py-12 px-6 border-t border-[var(--color-border)]">
      {/* Background gradient */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4">
            {[
              ...
              { name: "kaggle", url: "https://www.kaggle.com/prashantdubey2107" }
            ].map((social) => (
              <motion.a
                key={social.name}
                href={social.url}
                ...
                className="w-10 h-10 rounded-full glass flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent-primary)] transition-colors"
        ...
        {/* Made with love */}
        <motion.p
          className="text-center text-[var(--color-text-muted)] text-xs mt-8"
          initial={{ opacity: 0 }}
